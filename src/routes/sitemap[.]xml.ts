...
const BASE_URL = "https://unique-beauty-clinic.lovable.app";
...
const routes = [
  ...
  { path: "/bridal", priority: "0.9", changefreq: "monthly" as const },
...
const serviceSlugs = [
  "hair-cuts", "hair-treatments", "keratin-botox", "hair-color",
  "facials", "bridal-makeup", "manicure-pedicure", "nail-extensions",
  "waxing", "threading", "body-treatments", "eyelash-extensions",
];
